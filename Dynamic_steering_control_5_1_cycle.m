...
%%Compensator C(s) Pole-Zero Map analysis
%=================================================
mdl = 'Dynamic_steering_control_Go4';
op = findop(mdl,(1/2)*time)
close all

io(1) = linio('Dynamic_steering_control_Go4/C(s)/Gain4',1,'input');
io(2) = linio('Dynamic_steering_control_Go4/C(s)/Controller',1,'output');
io
...
%tranfer function
[NUM,DEN] = ss2tf(Am,Bm,Cm,Dm,1) %(from e to u)
C_s = tf([NUM],[DEN])
...
pzmap(C_s_v(1),C_s_v(2),C_s_v(3),C_s_v(4),C_s_v(5),C_s_v(6))%,C_s_v(7),C_s_v(8),C_s_v(9),C_s_v(10))
grid on
%=================================================
